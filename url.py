...
@simplebot.command
def sub():
    """Mandame el name del film al cual le buscas subtítulos y te mandare los resulatdos de https://opensubtitles.org/es\nEj: /sub Shazam"""
